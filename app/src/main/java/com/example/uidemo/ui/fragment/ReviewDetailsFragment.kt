...
import com.example.uidemo.databinding.FragmentReviewDetailsBinding
 ...
 * Use the [ReviewDetailsFragment.newInstance] factory method to
...
class ReviewDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.reviewModel = requireArguments().get(Keys.REVIEW_MODEL_KEY) as ReviewModel
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ReviewDetailsFragment.
         */
