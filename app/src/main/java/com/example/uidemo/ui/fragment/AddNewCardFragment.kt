...
import com.example.uidemo.databinding.FragmentAddNewCardBinding
 ...
 * Use the [AddNewCardFragment.newInstance] factory method to
...
class AddNewCardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSaveCard.setOnClickListener {
            ( activity as MainActivity).findNavController(R.id.nav_host_fragment).navigate(R.id.cardSettingFragment)
        }
    }
